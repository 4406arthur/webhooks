...
var (
	...
	ErrMissingAzureDevOpsEventHeader = errors.New("missing X-AzureDevOps-Event Header")
...
// Event defines a AzureDevOps hook event type
type Event string

// AzureDevOps hook types
const (
...
// Secret registers the AzureDevOps secret
...
func (hook Webhook) Parse(r *http.Request, events ...Event) (interface{}, error) {
	...
	event := r.Header.Get("X-AzureDevOps-Event")
	if event == "" {
		return nil, ErrMissingAzureDevOpsEventHeader
	}
	...
	// 	return pl, err
	default:
		return nil, fmt.Errorf("unknown event %s", gitEvent)
	}
}
